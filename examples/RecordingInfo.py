...
from src.schemas.requests import RecordingInfoRequest

async def main():
    meet_platform = PlugNMeet(base_url="http://127.0.0.1:8080", api_key="plugnmeet", api_secret="zumyyYWqv7KR2kUqvYdq4z4sXg7XTBD2ljT6")
    status, result = await meet_platform.recordingInfo(data=RecordingInfoRequest(record_id="fff44422_werwe"))
